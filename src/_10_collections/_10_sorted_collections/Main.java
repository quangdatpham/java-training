...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // stockList.Items().put("ga", new StockItem("ga", 23, 13));

        stockList.Items().get("car").adjustStock(-2);
        System.out.println(stockList.Items().get("car"));
    }
